...
// who we are - CARDS SUCCESS STORIES

function toggleStory(cardNumber) {
  const storyElement = document.getElementById(`story-${cardNumber}`);
  if (storyElement.style.display === "none" || storyElement.style.display === "") {
